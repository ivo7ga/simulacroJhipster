...
class AvionResourceIT {
    ...
    public static Avion createEntity(EntityManager em) {
        Avion avion = new Avion().tipo(DEFAULT_TIPO).matricula(DEFAULT_MATRICULA).edad(DEFAULT_EDAD).numeroSerie(DEFAULT_NUMERO_SERIE);
        return avion;
    }
    ...
    public static Avion createUpdatedEntity(EntityManager em) {
        Avion avion = new Avion().tipo(UPDATED_TIPO).matricula(UPDATED_MATRICULA).edad(UPDATED_EDAD).numeroSerie(UPDATED_NUMERO_SERIE);
        return avion;
    }
    ...
    void putNewAvion() throws Exception {
        ...
        updatedAvion.tipo(UPDATED_TIPO).matricula(UPDATED_MATRICULA).edad(UPDATED_EDAD).numeroSerie(UPDATED_NUMERO_SERIE);
    ...
    void fullUpdateAvionWithPatch() throws Exception {
        ...
        partialUpdatedAvion.tipo(UPDATED_TIPO).matricula(UPDATED_MATRICULA).edad(UPDATED_EDAD).numeroSerie(UPDATED_NUMERO_SERIE);
