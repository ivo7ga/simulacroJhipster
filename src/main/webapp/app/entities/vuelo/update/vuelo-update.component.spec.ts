...
describe('Vuelo Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Aeropuerto query and add missing value', () => {
      ...
      const aeropuerto: IAeropuerto = { id: 34038 };
      vuelo.aeropuerto = aeropuerto;
      const destinoAeropuerto: IAeropuerto = { id: 69703 };
      vuelo.destinoAeropuerto = destinoAeropuerto;
      ...
      const additionalAeropuertos = [aeropuerto, destinoAeropuerto];
    ...
    it('Should call Tripulante query and add missing value', () => {
      const vuelo: IVuelo = { id: 456 };
      const tripulantes: ITripulante[] = [{ id: 3487 }];
      ...
      const additionalTripulantes = [...tripulantes];
    ...
    it('Should update editForm', () => {
      const vuelo: IVuelo = { id: 456 };
      const aeropuerto: IAeropuerto = { id: 81311 };
      vuelo.aeropuerto = aeropuerto;
      const destinoAeropuerto: IAeropuerto = { id: 25090 };
      vuelo.destinoAeropuerto = destinoAeropuerto;
      const avion: IAvion = { id: 84608 };
      vuelo.avion = avion;
      const piloto: IPiloto = { id: 42707 };
      vuelo.piloto = piloto;
      const tripulantes: ITripulante = { id: 70358 };
      vuelo.tripulantes = [tripulantes];
      ...
      expect(comp.aeropuertosSharedCollection).toContain(destinoAeropuerto);
      expect(comp.avionsSharedCollection).toContain(avion);
      expect(comp.pilotosSharedCollection).toContain(piloto);
      expect(comp.tripulantesSharedCollection).toContain(tripulantes);
    });
  });
